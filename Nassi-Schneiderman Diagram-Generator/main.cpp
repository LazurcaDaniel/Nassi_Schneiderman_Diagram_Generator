...
//#define F_LATIME  1920
//#define F_LUNGIME 1080
...
void citesteSiDeseneaza()
{
    ...
    //cout<<instruction->children[1]->children[1]->type<<'\n';

    for(int i=0; i<=nr_instr; i++)
       cout<<LINE[i].instruction_type<<" ";
    cout<<endl;
    //cout<<instruction->children[1]->children[2]->type<<'\n';
            ...
            case VK_RETURN:
                switch (active)
                {
                    ...
                    case 1:
                    {
                        ...
                        {
                            citesteSiDeseneaza();
                           //ShellExecute(NULL, "open", "image.svg", NULL, NULL, SW_SHOWDEFAULT);
                            f_deschis = 2;
                            //getch();
                            ClearScreen();
                            drawMenu(active,f_deschis);
